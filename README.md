...
<dl>
<dt><a href="#elementStorage">elementStorage</a></dt>
<dd><p>Component to store data with HTMLElements without side effects
Stores any type of data by referance</p>
</dd>
</dl>
